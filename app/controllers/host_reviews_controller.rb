class HostReviewsController < ApplicationController
  ...
  def create
    # Step1: Check if the reservations exist (room_id, guest_id, host_id)

    # Step2: Check if the current host already reviewed thew guest in this reservation.
    ...
    if !@reservation.nil?
      ...
      @host_reviewed = HostReview.where(
